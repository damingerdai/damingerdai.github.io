---
title: Docker Desktop自带k8s安装笔记
date: 2021-01-14 14:34:54
...
对于Mac用户，请点击[Docker Desktop](https://desktop.docker.com/mac/stable/Docker.dmg)
对于Windows10用户，请点击[Docker Desktop](https://desktop.docker.com/win/stable/Docker%20Desktop%20Installer.exe)
...
```
现在可以访问： [http://localhost:8001/api/v1/namespaces/kubernetes-dashboard/services/https:kubernetes-dashboard:/proxy/](http://localhost:8001/api/v1/namespaces/kubernetes-dashboard/services/https:kubernetes-dashboard:/proxy/)
